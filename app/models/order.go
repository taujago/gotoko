...
type Order struct {
	...
	BaseTotalPrice      decimal.Decimal `gorm:"type:float(10,2)"`
	TaxAmount           decimal.Decimal `gorm:"type:float(10,2)"`
	TaxPercent          decimal.Decimal `gorm:"type:float(10,2)"`
	DiscountAmount      decimal.Decimal `gorm:"type:float(10,2)"`
	DiscountPercent     decimal.Decimal `gorm:"type:float(10,3)"`
